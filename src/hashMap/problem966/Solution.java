...
public class Solution {
    // #1. HashMap Approach
    // Time Complexity: O((m + n) * k), where m is the total length of all words in wordlist,
    // n is the number of queries, and k is the average length of each query.
    // Space Complexity: O(n * k), for storing the maps.
